            ...
            <div className="p-4 sm:p-6 space-y-6 overflow-y-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-[9px] sm:text-[10px] text-gray-400 uppercase font-bold tracking-wider">KYC Status</label>
                    <p className="text-xs sm:text-sm font-semibold text-emerald-600">{selectedRequest.customer?.kycStatus?.toUpperCase()}</p>
                  </div>
                </div>
              </div>
