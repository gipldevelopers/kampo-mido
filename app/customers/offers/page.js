...
const CategoryBadge = ({ type }) => {
  ...
  return (
    <span
      className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase border ${styles[type] || "bg-muted text-muted-foreground"}`}
    >
      {type}
    </span>
  );
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Unlock exclusive benefits for your transactions.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0 space-y-3">
                ...
                <p className="text-sm text-muted-foreground line-clamp-2 leading-relaxed">
                  {offer.description ||
                    "Apply this code during your next transaction to claim your reward."}
                </p>
