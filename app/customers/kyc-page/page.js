      ...
      {preview ? (
        ...
        <label className="cursor-pointer">
          ...
          <div className="flex flex-col items-center justify-center w-full px-4 py-8 bg-muted/30 border-2 border-dashed border-border rounded-lg hover:border-primary/50 transition-colors">
            ...
            <p className="text-sm font-medium text-foreground mb-1">Click to upload {title.toLowerCase()}</p>
    ...
    <div className="space-y-6 animate-in fade-in duration-500 relative min-h-screen pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Upload your documents to complete KYC verification.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-lg font-semibold text-foreground">ID Documents</h3>
            </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-lg font-semibold text-foreground">Selfie Verification</h3>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
            <p className="text-sm font-medium text-foreground mb-2">KYC Requirements</p>
