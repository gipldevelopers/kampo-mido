...
export default function CustomerNavbar({ onMenuClick }) {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, title: "New Deposit", description: "Deposit confirmed ₹50,000", time: "2 min ago", type: "Deposit", dotColor: "bg-green-500" },
    { id: 2, title: "KYC Pending", description: "KYC verification in progress", time: "1 hour ago", type: "KYC", dotColor: "bg-red-500" },
                ...
                {notifications.length === 0 ? (
                  ...
                  <div className="divide-y divide-border/50">
                    {notifications.map((notif) => {
                      return (
                        <div key={notif.id} className="p-2.5 sm:p-3 md:p-3.5 hover:bg-muted/50 transition-colors">
